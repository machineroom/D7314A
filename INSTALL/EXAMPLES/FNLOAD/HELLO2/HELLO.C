 ...
 *  prints out "hello world from child x" and which then goes on to call
 *  other children that print out "hello world from child x"; the child
 *  code requires static, heap and i/o.
 *
 *  The child code is expected already to be in a .rsc file called "helloa.rsc".
 */
...
#include <fnload.h>
#include <hostlink.h>
#define CHILD_HEAP_SIZE_IN_BYTES  (size_t)196608   /* 192K */


int main( void )
{
  char* rsc_filename = "helloa.rsc";
